...
//      dd($content);
    ...
    /**
     * Not really needing this feature anymore
     * @test
     * @return void
     */
...
//        dd($content);
     ...
     * @return void
     */
    public function it_throws_an_exception_when_a_user_tries_to_create_a_duplicate_item_with_the_same_parent_if_the_parent_id_is_none()
    {
        $this->logInUser();
